...
#    -DLLVM_PREFIX=/path/to/llvm/installation
...
STRING(REGEX REPLACE "-.*" "" HOST_ARCH "${TARGET_TRIPLE}")
set(LLVM_PREFIX $ENV{SMAKE_LLVM_PREFIX})
set(MSVC_BASE $ENV{SMAKE_LLVM_MSVC_PATH})
set(WINSDK_BASE $ENV{SMAKE_LLVM_WINDOWS_KITS_10_PATH})
set(WINSDK_VER $ENV{SMAKE_LLVM_WINDOWS_KITS_10_VERSION})

message(STATUS "LLVM_PREFIX: \"${LLVM_PREFIX}\"")
message(STATUS "MSVC_BASE: \"${MSVC_BASE}\"")
message(STATUS "WINSDK_BASE: \"${WINSDK_BASE}\"")
...
set(CMAKE_C_COMPILER "${LLVM_PREFIX}clang-cl" CACHE FILEPATH "")
set(CMAKE_CXX_COMPILER "${LLVM_PREFIX}clang-cl" CACHE FILEPATH "")
set(CMAKE_LINKER "${LLVM_PREFIX}lld-link" CACHE FILEPATH "")
...
list(APPEND _CTF_NATIVE_DEFAULT "-DCMAKE_ASM_COMPILER=${LLVM_PREFIX}clang")
list(APPEND _CTF_NATIVE_DEFAULT "-DCMAKE_C_COMPILER=${LLVM_PREFIX}clang")
list(APPEND _CTF_NATIVE_DEFAULT "-DCMAKE_CXX_COMPILER=${LLVM_PREFIX}clang++")
